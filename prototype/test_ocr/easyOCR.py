...
class EasyOCRTester:
    ...
    def get_reader(self, languages: List[str]):
    ...
    def extract_text_easyocr(self, image_path: str, languages: List[str] = None) -> str:
    ...
    def test_language_dataset(self, language: str) -> Dict[str, any]:
        ...
        languages = ['en'] if language == 'english' else ['fr', 'en']
        ...
        for filename, gt_text in ground_truth.items():
            ...
            predicted_text = self.extract_text_easyocr(str(img_path), languages)
    ...
    def save_detailed_results(self, results: Dict[str, any], output_file: str = "easyocr_test_results.json"):
...
def main():
    ...
    try:
        ...
        print("Error: EasyOCR not found. Please install EasyOCR.")
